...
from add_electricity import calculate_annuity, calculate_offwind_cost, sanitize_carriers
...
def patch_electricity_network(n):
    ...
    # not needed for the offshore analysis and to avoid error currently disabled
